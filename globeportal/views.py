...
from globeportal.models import  (DRANEF,DPANEF,ZDTF,DFP,Region, Province, Commune, Forest, Canton, Groupe, Parcelle,Species,ParcelSpecies,PointCloudMetaData,ShapefileUpload)

from globeportal.serializers import (DRANEFSerializer,DPANEFSerializer,ZDTFSerializer,DFPSerializer,RegionSerializer, ProvinceSerializer, CommuneSerializer, ForestSerializer, CantonSerializer, GroupeSerializer, ParcelleSerializer,SpeciesSerializer,ParcelSpeciesSerializer,PointCloudMetaDataSerializer)

from globeportal.pagination import LargeResultsSetPagination


# Create your views here.
def cesium_view(request):
    return render(request, 'globeportal/index.html')

def home(request):
    return render(request, 'globeportal/home.html')

def portal(request):
    return render(request, 'globeportal/portal.html')

def contact_us(request):
    return render(request, 'globeportal/contact_us.html')

def about_us(request):
    return render(request, 'globeportal/about_us.html')

def signup(request):
    return render(request, 'globeportal/inscription/signup.html')
