"""
Django settings for globegeoportal project.
...
SECRET_KEY = 'django-insecure-!^4!@jernusnxf_qk%_2gux-$y&y$izd!^dh=1mcm^1be8^t(t'
...
WSGI_APPLICATION = 'globegeoportal.wsgi.application'
